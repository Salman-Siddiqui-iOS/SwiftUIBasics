...
extension SwiftUIBasicsApp_Previews {
    @_dynamicReplacement(for: previews) private static var __preview__previews: some View {
        ...
        /*@START_MENU_TOKEN@*/__designTimeSelection(Text(__designTimeString("#9023.[2].[0].property.[0].[0].arg[0].value", fallback: "Hello, World!")), "#9023.[2].[0].property.[0].[0]")/*@END_MENU_TOKEN@*/
    #sourceLocation()
    }
}
...
extension SwiftUIBasicsApp {
    @_dynamicReplacement(for: notes123()) private static func __preview__notes123() -> NoteList {
        ...
        return __designTimeSelection(note, "#9023.[1].[1].[2]")
    #sourceLocation()
    }
}
